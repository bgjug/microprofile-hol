...
If you want your resorce to be exposed directly at the root path, add this content to content/src/main/webapp/WEB-INF/ibm-web-ext.xml:
...
This time, after running the maven build, you'll get content.jar file in the target directoy.
