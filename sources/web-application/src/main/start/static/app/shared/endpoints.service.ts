...
export class EndpointsService {
    ...
    {
        'advertisers': <Endpoint> { name: 'speaker', url: 'http://localhost:9100/advertisers' },
        'session': <Endpoint> { name: 'authors', url: 'http://localhost:9110/authors' },
        'schedule': <Endpoint> { name: 'subscribers', url: 'http://localhost:9120/content' },
        'vote': <Endpoint> { name: 'vote', url: 'http://localhost:9130/subscribers' }
    };
    error: string;
    endpoints: Endpoints;
    ...
    private getEndpoints(): Promise<Endpoints> {
        ...
        return this.http.get('/service/endpoints/magman')
            .toPromise()
